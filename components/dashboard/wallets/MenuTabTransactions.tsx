  ...
  return (
    <div className="flex items-center gap-6 mb-4 mx-auto text-center">
      <div
        ...
        className={clsx(
          "flex items-center gap-2 border-b-2 text-xl pb-3 hover:text-red-700 duration-500 font-semibold cursor-pointer",
          {
      ...
      <div
        ...
        className={clsx(
          "flex items-center gap-2 border-b-2 text-xl pb-3 hover:text-blue-700 duration-500 font-semibold cursor-pointer",
          {
