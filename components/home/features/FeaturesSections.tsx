...
const FeaturesSections = () => {
  ...
  return (
    <div className="p-9 min-h-screen flex flex-col gap-10 my-10">
      ...
      <div ref={ref} className="flex justify-center relative gap-4">
        <div className="flex flex-col gap-20 flex-1 items-center">
          <InView onChange={setInView} threshold={0.5} id="expenses">
            <div
              ref={ref}
              className="w-[650px] h-[630px] bg-slate-50 rounded-lg relative flex justify-center mb-28 shadow-md"
            >
              <img src={iphoneUI.src} alt="" className="absolute top-36" />
            </div>
          </InView>
        ...
        <div className="flex-1">
          <div className="w-2/3  sticky top-48 bottom-10 mx-auto flex flex-col gap-10">
